...
import { ArrowLeft, FileText, Download, ExternalLink, ChevronDown, Lock, ShieldCheck, Sparkles, Crown, Sun, Moon, Play, BookOpen, CircleAlert as AlertCircle, ChevronRight, Award, ClipboardList, Library } from 'lucide-react';
...
/* ──────────────────────────────────────────────
   THEME SYSTEM (matches premium CollateralFormsPage)
   ────────────────────────────────────────────── */
  ...
  return (
    <div style={{ position: 'fixed', inset: 0, overflow: 'hidden', pointerEvents: 'none', zIndex: 0, opacity: 'var(--grid-opacity)' }}>
      <svg width="100%" height="100%">
        <defs>
          <pattern id="templatesGrid" width="48" height="48" patternUnits="userSpaceOnUse">
            <path d="M 48 0 L 0 0 0 48" fill="none" stroke="var(--accent-gold)" strokeWidth="0.4" />
          </pattern>
          <pattern id="templatesGridDiag" width="96" height="96" patternUnits="userSpaceOnUse">
            <path d="M 0 96 L 96 0" fill="none" stroke="var(--accent-gold)" strokeWidth="0.2" opacity="0.5" />
          </pattern>
        </defs>
        <rect width="100%" height="100%" fill="url(#templatesGrid)" />
        <rect width="100%" height="100%" fill="url(#templatesGridDiag)" />
      </svg>
    </div>
  );
}
...
const TemplatesSection: React.FC<{
  ...
  isOpen: boolean;
  onToggle: () => void;
}> = ({ id, title, subtitle, emoji, icon, docs, isOpen, onToggle }) => {
  return (
    <div
      id={id}
...
const submissionToolsDocs: TemplateDocument[] = [
  {
    id: 'roc-upgraded-cerificate',
    title: "Release of Collateral Upgraded Certificate",
    description: "Certificate of Completion for completing the SmallBiz Recon™ Release of Collateral Interactive Guide Quiz",
    volume: "Certificate",
    viewUrl: "https://zrktinvphjmalvrsjmii.supabase.co/storage/v1/object/sign/SmallBiz%20Recon%20Paid%20Templates/ROC%20SUBMISSION%20CHECKLIST.pdf%20(1).pdf?token=eyJraWQiOiJzdG9yYWdlLXVybC1zaWduaW5nLWtleV8xZmUwNzEzYS00ZTVhLTQ3ZWYtODNlNS0xYjgxOWVlMjk2NzgiLCJhbGciOiJIUzI1NiJ9.eyJ1cmwiOiJTbWFsbEJpeiBSZWNvbiBQYWlkIFRlbXBsYXRlcy9ST0MgU1VCTUlTU0lPTiBDSEVDS0xJU1QucGRmICgxKS5wZGYiLCJpYXQiOjE3NzE5NTE3MTUsImV4cCI6MTgzMDI3MTcxNX0.tyeu8b8HxIGISZGtwEuyspbY54kX0c0lIs-e7608FQA",
    ...
    customDate: "*LAST UPDATED FEBRUARY 24, 2026*",
    accentColor: "#CDA349",
  },
  {
    id: 'roc-submission-checklist',
    ...
    viewUrl: "https://zrktinvphjmalvrsjmii.supabase.co/storage/v1/object/sign/SmallBiz%20Recon%20Paid%20Templates/ROC%20SUBMISSION%20CHECKLIST%20(2026).pdf?token=eyJraWQiOiJzdG9yYWdlLXVybC1zaWduaW5nLWtleV8xZmUwNzEzYS00ZTVhLTQ3ZWYtODNlNS0xYjgxOWVlMjk2NzgiLCJhbGciOiJIUzI1NiJ9.eyJ1cmwiOiJTbWFsbEJpeiBSZWNvbiBQYWlkIFRlbXBsYXRlcy9ST0MgU1VCTUlTU0lPTiBDSEVDS0xJU1QgKDIwMjYpLnBkZiIsImlhdCI6MTc3MTgyOTE4MiwiZXhwIjoxODMwMjM1NTgyfQ.OqX9Oak0Lc0LOqGf3frgDoCEbEChUOgYA9fxEKbr5Qw",
    downloadPath: "https://zrktinvphjmalvrsjmii.supabase.co/storage/v1/object/sign/SmallBiz%20Recon%20Paid%20Templates/ROC%20SUBMISSION%20CHECKLIST%20(2026).pdf?token=eyJraWQiOiJzdG9yYWdlLXVybC1zaWduaW5nLWtleV8xZmUwNzEzYS00ZTVhLTQ3ZWYtODNlNS0xYjgxOWVlMjk2NzgiLCJhbGciOiJIUzI1NiJ9.eyJ1cmwiOiJTbWFsbEJpeiBSZWNvbiBQYWlkIFRlbXBsYXRlcy9ST0MgU1VCTUlTU0lPTiBDSEVDS0xJU1QgKDIwMjYpLnBkZiIsImlhdCI6MTc3MTgyOTE4MiwiZXhwIjoxODMwMjM1NTgyfQ.OqX9Oak0Lc0LOqGf3frgDoCEbEChUOgYA9fxEKbr5Qw",
    customDate: "*LAST UPDATED FEBRUARY 22, 2026*",
    accentColor: "#CDA349",
  },
  {
    id: 'roc-submission-cover-sheet',
    ...
    viewUrl: "https://zrktinvphjmalvrsjmii.supabase.co/storage/v1/object/sign/SmallBiz%20Recon%20Paid%20Templates/ROC_COVER_AND_%20CHECKLIST_(2026).pdf?token=eyJraWQiOiJzdG9yYWdlLXVybC1zaWduaW5nLWtleV8xZmUwNzEzYS00ZTVhLTQ3ZWYtODNlNS0xYjgxOWVlMjk2NzgiLCJhbGciOiJIUzI1NiJ9.eyJ1cmwiOiJTbWFsbEJpeiBSZWNvbiBQYWlkIFRlbXBsYXRlcy9ST0NfQ09WRVJfQU5EXyBDSEVDS0xJU1RfKDIwMjYpLnBkZiIsImlhdCI6MTc3MTgyOTAwMSwiZXhwIjoxODMwMjM1NDAxfQ.d6-rYMToL7lYxdaugLdTVxcItJtgQkXxUj26ivWofeI",
...
const CollateralTemplatesPage: React.FC = () => {
    ...
    <>
      <style>{`
        ...
        @keyframes borderGlow {
          ...
          50% { border-color: rgba(200,168,78,0.35); }
        }
        ...
        * { box-sizing: border-box; }
        ...
        .templates-page a { color: inherit; }

        @media (max-width: 768px) {
          .templates-hero-title { font-size: 28px !important; }
          .templates-hero-inner { padding: 36px 16px 48px !important; }
          .templates-stats-grid { grid-template-columns: 1fr 1fr !important; }
        }
      `}</style>
      ...
      <div className="templates-page">
        ...
        <div style={{ position: 'relative', zIndex: 1 }}>
          ...
          <div style={{
            ...
            <div className="templates-hero-inner" style={{
              maxWidth: 1200,
              margin: '0 auto',
              ...
              <h1 className="templates-hero-title" style={{
                fontFamily: 'var(--font-display)',
                fontSize: 46,
                fontWeight: 400,
                textAlign: 'center',
              ...
              <p style={{
                ...
                Essential templates, guides, and official documents designed to help you navigate the SBA system with confidence and clarity — whether you're submitting a servicing request or planning your next move.
              </p>
              ...
              {/* Stats row */}
              <div
                className="templates-stats-grid"
                style={{
                  display: 'grid',
          ...
          <div style={{ maxWidth: 1200, margin: '0 auto', padding: '48px 24px 8px' }}>
            <div style={{
              ...
              <h2 style={{
                ...
                Expert SBA DIY tools to help guide you through{' '}
              ...
              <p style={{
                ...
                Helpful templates & documents compiled by former SBA insiders to help you succeed
              </p>
            </div>
          </div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
              ...
              <div style={{ animation: 'fadeSlideUp 0.7s ease-out 0.35s both' }}>
                <TemplatesSection
                  ...
                  subtitle="Certificates, checklists, cover sheets, authorization forms, and official SBA documents needed for your submission packages."
                  emoji="🛠️"
              ...
              <div style={{ display: 'flex', alignItems: 'flex-start', gap: 12 }}>
                ...
                <div>
                  ...
                  <div style={{
                    ...
                    <p>• All SmallBiz Recon™ templates & documents are regularly reviewed and updated</p>
...
export default CollateralTemplatesPage;