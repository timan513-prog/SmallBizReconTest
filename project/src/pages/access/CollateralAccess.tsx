...
import { ArrowLeft, FileText, Download, Monitor, Package, CircleCheck as CheckCircle, FolderOpen, X, Mail, ExternalLink, MessageSquare, ShieldCheck, Sparkles, Lock, ChevronRight, Crown, Zap, Star, Award, Sun, Moon } from 'lucide-react';
...
interface ToolkitContentProps {
  toolkitType: 'collateral-release';
  onClose: () => void;
  startResourceId?: string | null;
}

/* ──────────────────────────────────────────────
   THEME SYSTEM (elevated beyond free guides page)
   ────────────────────────────────────────────── */
...
/* ──────────────────────────────────────────────
   AMBIENT EFFECTS (premium tier — gold particles,
   hexagonal grid, shimmer lines)
   ────────────────────────────────────────────── */
  ...
  return (
    ...
    >
      <svg width="100%" height="100%">
        <defs>
          <pattern id="premGrid" width="48" height="48" patternUnits="userSpaceOnUse">
            <path d="M 48 0 L 0 0 0 48" fill="none" stroke="var(--accent-gold)" strokeWidth="0.4" />
          </pattern>
          <pattern id="premGridDiag" width="96" height="96" patternUnits="userSpaceOnUse">
            <path d="M 0 96 L 96 0" fill="none" stroke="var(--accent-gold)" strokeWidth="0.2" opacity="0.5" />
          </pattern>
        </defs>
        <rect width="100%" height="100%" fill="url(#premGrid)" />
        <rect width="100%" height="100%" fill="url(#premGridDiag)" />
      </svg>
    </div>
  );
}
...
/* ──────────────────────────────────────────────
   PREMIUM RESOURCE CARD (glass + accent bar + glow)
   ────────────────────────────────────────────── */
...
const PremiumResourceCard: React.FC<{
  ...
  const cardContent = (
    ...
    >
      ...
      {/* Gold shimmer line at top for premium feel */}
      <div
        style={{
          position: 'absolute',
          top: 0,
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 16 }}>
          <div
            style={{
              ...
              ...(hovered ? { background: `${accent}25`, borderColor: `${accent}55` } : {}),
            }}
          >
            {resource.icon}
          </div>
  ...
  if (resource.isInteractive) {
    return (
      <div onClick={() => onLaunchInteractive(resource)} style={{ display: 'flex' }}>
        {cardContent}
      </div>
    );
  }
  ...
  if (resource.type === 'internal-link') {
    return (
      <Link to={resource.link} onClick={onCloseModal} style={{ textDecoration: 'none', display: 'flex' }}>
        {cardContent}
      </Link>
    );
  }
  ...
  return (
    <a
      href={resource.type === 'pdf' ? `${resource.link}#page=1` : resource.link}
      target="_blank"
...
/* ──────────────────────────────────────────────
   TOOLKIT MODAL (premium glass overlay)
   ────────────────────────────────────────────── */
...
const ToolkitContent: React.FC<ToolkitContentProps> = ({ toolkitType, onClose, startResourceId }) => {
  ...
  const toolkitData: ToolkitData | null = useMemo(() => {
    switch (toolkitType) {
      case 'collateral-release':
        return {
          title: 'DIY COVID EIDL Release of Collateral Toolkit',
          description: 'Expert guidance for DIY collateral release',
          resources: [
            {
              id: 'roc-html',
              icon: <ExternalLink size={20} style={{ color: '#5d9ecf' }} />,
              title: 'Interactive HTML Guide',
              description: 'Step-by-step visual guide for collateral release process',
              link: '/interactive-collateral-guide.html',
            ...
            },
            {
              ...
              description: 'Complete Premium PDF reference guide for the collateral release process',
              link: 'https://rufgrcaxemvewhqiayfk.supabase.co/storage/v1/object/sign/SMALLBIZ%20RECON/COVID_EIDL_Release_of_Collateral_Premium_Guide_2026.pdf?token=eyJraWQiOiJzdG9yYWdlLXVybC1zaWduaW5nLWtleV85MzZjNmFmNC1iMzA2LTQzMmMtYWFjNy03ZmRmYjU1NDRjMzUiLCJhbGciOiJIUzI1NiJ9.eyJ1cmwiOiJTTUFMTEJJWiBSRUNPTi9DT1ZJRF9FSURMX1JlbGVhc2Vfb2ZfQ29sbGF0ZXJhbF9QcmVtaXVtX0d1aWRlXzIwMjYucGRmIiwiaWF0IjoxNzY5ODQyMjYxLCJleHAiOjE4NjE4NTgyNjF9.qQcwd9qUIpz3SRzKqJXPPVrrbEzFyEWRK5D3XBWmVYo',
            ...
            },
            {
              ...
              title: 'Printable PDF Reference Guide',
              description: 'Complete PDF reference guide for the collateral release process',
              link: 'https://rufgrcaxemvewhqiayfk.supabase.co/storage/v1/object/sign/SMALLBIZ%20RECON/COVID%20EIDL%20Release%20of%20Collateral%20Toolkit%20(PDF%20PRINT).pdf?token=eyJraWQiOiJzdG9yYWdlLXVybC1zaWduaW5nLWtleV85MzZjNmFmNC1iMzA2LTQzMmMtYWFjNy03ZmRmYjU1NDRjMzUiLCJhbGciOiJIUzI1NiJ9.eyJ1cmwiOiJTTUFMTEJJWiBSRUNPTi9DT1ZJRCBFSURMIFJlbGVhc2Ugb2YgQ29sbGF0ZXJhbCBUb29sa2l0IChQREYgUFJJTlQpLnBkZiIsImlhdCI6MTc2OTg4MDk2MywiZXhwIjoxODYxODk2OTYzfQ.pM6vE6CXy4_7YGl3FiCRxwo_z6RMR7Wy3FvQxIaDlMs',
              type: 'pdf' as ResourceType,
              accentColor: '#cf5d5d',
            },
            {
            ...
            },
            {
              ...
              link: '/access/collateral-release/templates',
  ...
  useEffect(() => {
    if (!toolkitData || !startResourceId) return;
    ...
    >
      ...
      <div
        style={{
          ...
          maxHeight: '90vh',
          overflowY: 'auto',
          boxShadow: '0 32px 80px rgba(0,0,0,0.5), 0 0 0 1px var(--border-gold)',
          border: '1px solid var(--border-gold)',
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 14, marginBottom: 12 }}>
              ...
              <div>
                <h2 style={{ fontFamily: 'var(--font-display)', fontSize: 26, fontWeight: 400 }}>
                  Access{' '}
                  <span style={{ fontStyle: 'italic', color: '#cda349' }}>Granted</span>
                </h2>
                <div
                  style={{
                    display: 'flex',
              ...
              >
                {toolkitData.resources.map((resource, i) => (
                  <PremiumResourceCard
                    ...
                    resource={resource}
                    index={i}
                    onLaunchInteractive={(r) => setInteractiveResource(r)}
...
/* ──────────────────────────────────────────────
   MAIN PAGE: CollateralAccess
   ────────────────────────────────────────────── */

const CollateralAccess: React.FC = () => {
  ...
  // Supabase URLs (preserved exactly)
  const supabaseTrackingToolsUrl =
    'https://rufgrcaxemvewhqiayfk.supabase.co/storage/v1/object/sign/SMALLBIZ%20RECON/SBA%20Interactive%20Contact%20Log%202.0%20(2026).xlsx?token=eyJraWQiOiJzdG9yYWdlLXVybC1zaWduaW5nLWtleV85MzZjNmFmNC1iMzA2LTQzMmMtYWFjNy03ZmRmYjU1NDRjMzUiLCJhbGciOiJIUzI1NiJ9.eyJ1cmwiOiJTTUFMTEJJWiBSRUNPTi9TQkEgSW50ZXJhY3RpdmUgQ29udGFjdCBMb2cgMi4wICgyMDI2KS54bHN4IiwiaWF0IjoxNzY5ODgyNDEwLCJleHAiOjE4NjE4OTg0MTB9.tKzAlu5Kx070zeglr8pxBTLVUMqrwT3p7NMkXNsdsps';

  const pdfProUrl =
    'https://rufgrcaxemvewhqiayfk.supabase.co/storage/v1/object/sign/SMALLBIZ%20RECON/COVID_EIDL_Release_of_Collateral_Premium_Guide_2026.pdf?token=eyJraWQiOiJzdG9yYWdlLXVybC1zaWduaW5nLWtleV85MzZjNmFmNC1iMzA2LTQzMmMtYWFjNy03ZmRmYjU1NDRjMzUiLCJhbGciOiJIUzI1NiJ9.eyJ1cmwiOiJTTUFMTEJJWiBSRUNPTi9DT1ZJRF9FSURMX1JlbGVhc2Vfb2ZfQ29sbGF0ZXJhbF9QcmVtaXVtX0d1aWRlXzIwMjYucGRmIiwiaWF0IjoxNzY5ODQyMjYxLCJleHAiOjE4NjE4NTgyNjF9.qQcwd9qUIpz3SRzKqJXPPVrrbEzFyEWRK5D3XBWmVYo';

  const pdfPrintUrl =
    'https://rufgrcaxemvewhqiayfk.supabase.co/storage/v1/object/sign/SMALLBIZ%20RECON/COVID%20EIDL%20Release%20of%20Collateral%20Toolkit%20(PDF%20PRINT).pdf?token=eyJraWQiOiJzdG9yYWdlLXVybC1zaWduaW5nLWtleV85MzZjNmFmNC1iMzA2LTQzMmMtYWFjNy03ZmRmYjU1NDRjMzUiLCJhbGciOiJIUzI1NiJ9.eyJ1cmwiOiJTTUFMTEJJWiBSRUNPTi9DT1ZJRCBFSURMIFJlbGVhc2Ugb2YgQ29sbGF0ZXJhbCBUb29sa2l0IChQREYgUFJJTlQpLnBkZiIsImlhdCI6MTc2OTg4MDk2MywiZXhwIjoxODYxODk2OTYzfQ.pM6vE6CXy4_7YGl3FiCRxwo_z6RMR7Wy3FvQxIaDlMs';

  useEffect(() => {
    setUnlockedToolkit(TOOLKIT_TYPES.COLLATERAL_RELEASE);
  }, []);
    ...
    <>
      <style>{`
        ...
        * { box-sizing: border-box; }
        ...
        .prem-page a { color: inherit; }

        @media (max-width: 768px) {
          .prem-hero-title { font-size: 30px !important; }
          .prem-hero-inner { padding: 36px 16px 48px !important; }
          .prem-cards-grid { grid-template-columns: 1fr !important; }
        }
      `}</style>
          ...
          >
            ...
            <div
              style={{
                ...
                height: 500,
                borderRadius: '50%',
                background: 'radial-gradient(circle, rgba(200,168,78,0.1) 0%, transparent 55%)',
                pointerEvents: 'none',
            ...
            >
              ...
              >
                <Crown size={36} color="#cda349" strokeWidth={1.5} />
              </div>
              ...
              >
                COVID EIDL Release of{' '}
                <span style={{ fontStyle: 'italic', color: '#cda349' }}>Collateral Toolkit</span>
              </h1>
              ...
              >
                Your complete DIY guide for navigating the SBA COVID EIDL collateral release process
                with confidence. All materials included with lifetime access.
              </p>
              ...
              >
                <button
                  ...
                  style={{
                    ...
                    cursor: 'pointer',
                    transition: 'all 0.3s ease',
                    boxShadow: '0 0 30px rgba(200,168,78,0.1)',
                  }}
                >
                  <Package size={18} />
            ...
            >
              ...
              <div
                style={{
                  ...
                  height: 200,
                  borderRadius: '50%',
                  background: 'radial-gradient(circle, rgba(200,168,78,0.1), transparent 60%)',
                  pointerEvents: 'none',
                }}
              />
              ...
              <div style={{ position: 'relative', zIndex: 1 }}>
                ...
                >
                  Welcome to your complete collateral release toolkit. All materials are included with
                  your purchase and available for lifetime access.
                </p>
                ...
                >
                  ...
                  >
                    🤖 Sabbi 2.0 is unlocked — tap the Sabbi button in the bottom right to ask
                    collateral-release questions.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div style={{ maxWidth: 1200, margin: '0 auto', padding: '40px 24px' }}>
            ...
            >
              ...
              <AccessCard
                ...
                description="Step-by-step interactive HTML toolkit with clickable roadmap and visual process flow."
                accentColor="#5d9ecf"
                ...
                badge="Interactive"
                actionElement={
                  <PremiumButton onClick={() => openModal('roc-html')} accentColor="#5d9ecf" icon={<Zap size={16} />}>
                    Launch Guide
                  </PremiumButton>
                }
              />
              ...
              <AccessCard
                ...
                description="Premium PDF guide for comprehensive insights, detailed walkthroughs, and advanced reference material."
                accentColor="#cda349"
                ...
                badge="Pro"
                actionElement={
                  <PremiumButton href={pdfProUrl} accentColor="#cda349" icon={<Download size={16} />}>
                    Download PDF Pro
                  </PremiumButton>
                }
              />
              ...
              <AccessCard
                ...
                actionElement={
                  <PremiumButton href={pdfPrintUrl} accentColor="#cf5d5d" icon={<Download size={16} />}>
                    Download PDF
                  </PremiumButton>
                }
              />
              ...
              <AccessCard
                ...
                badge="2026"
                actionElement={
                  <PremiumButton href={supabaseTrackingToolsUrl} accentColor="#5daa5d" icon={<Download size={16} />}>
                    Download Tools
                  </PremiumButton>
                }
              />
              ...
              <AccessCard
                index={4}
                title="Templates & Docs"
                description="Sample letters, forms, and professional templates for your collateral release requests."
                accentColor="#9e7ec8"
                iconBg="rgba(158,126,200,0.12)"
                iconBorder="rgba(158,126,200,0.3)"
                icon={<Mail size={26} style={{ color: '#9e7ec8' }} />}
                actionElement={
                  <PremiumButton to="/access/collateral-release/templates" accentColor="#9e7ec8" variant="outline" icon={<FileText size={16} />}>
                    View Templates
                  </PremiumButton>
                }
              />

              {/* 6. Advanced Forms Library */}
              <AccessCard
                index={5}
                title="Advanced Forms Library"
                description="View all premium collateral release forms categorized by usage — ready-to-use and professionally formatted."
                accentColor="#e0943d"
                iconBg="rgba(224,148,61,0.12)"
                iconBorder="rgba(224,148,61,0.3)"
                icon={<FolderOpen size={26} style={{ color: '#e0943d' }} />}
                actionElement={
                  <PremiumButton to="/access/collateral-release/forms" accentColor="#e0943d" icon={<ChevronRight size={16} />}>
                    View Forms
                  </PremiumButton>
                }
              />
            ...
            >
              <div
                style={{
                  ...
                  height: 400,
                  borderRadius: '50%',
                  background: 'radial-gradient(circle, rgba(200,168,78,0.06) 0%, transparent 55%)',
                  pointerEvents: 'none',
                }}
              />
              ...
              <div style={{ position: 'relative', zIndex: 1 }}>
                ...
                >
                  ...
                  <span style={{ fontStyle: 'italic', color: 'var(--accent-gold)' }}>Interactive Toolkit</span>
                </h2>
                ...
                >
                  Launch the interactive guide to render the full toolkit experience with step-by-step
                  navigation.
                </p>
            ...
            >
              <div style={{ display: 'flex', alignItems: 'flex-start', gap: 12 }}>
                ...
                <div>
                  ...
                  >
                    SmallBiz Recon™ is an independent educational resource and is not affiliated with,
                    endorsed by, or connected to any government agency. All information is provided for
                    educational and informational purposes only. Always consult with qualified
                    professionals and verify all information with official sources before making any
                    decisions.
                  </p>
                </div>
              </div>
...
export default CollateralAccess;