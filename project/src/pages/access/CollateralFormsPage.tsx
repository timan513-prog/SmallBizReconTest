...
import { ArrowLeft, FileText, Download, ExternalLink, ChevronDown, Lock, ShieldCheck, Sparkles, Crown, Sun, Moon, Play, BookOpen, CircleAlert as AlertCircle, ChevronRight } from 'lucide-react';
...
/* ──────────────────────────────────────────────
   THEME SYSTEM (matches premium CollateralAccess)
   ────────────────────────────────────────────── */
  ...
  return (
    <div style={{ position: 'fixed', inset: 0, overflow: 'hidden', pointerEvents: 'none', zIndex: 0, opacity: 'var(--grid-opacity)' }}>
      <svg width="100%" height="100%">
        <defs>
          <pattern id="formsGrid" width="48" height="48" patternUnits="userSpaceOnUse">
            <path d="M 48 0 L 0 0 0 48" fill="none" stroke="var(--accent-gold)" strokeWidth="0.4" />
          </pattern>
          <pattern id="formsGridDiag" width="96" height="96" patternUnits="userSpaceOnUse">
        ...
        <rect width="100%" height="100%" fill="url(#formsGridDiag)" />
      </svg>
    </div>
  );
}
...
const isDualButtonForm = (title: string): boolean => {
  return (
    title === 'Collateral Release Intended Use Letter' ||
    title === 'Collateral Release Intended Use Letter - Real Estate' ||
...
const sectionStyles = {
  required: { accent: 'var(--accent-red)', label: 'Required', emoji: '🔴', barColor: '#cf6b6b' },
  optional: { accent: 'var(--accent-yellow)', label: 'Could Be Requested', emoji: '🟡', barColor: '#d4b76a' },
  informational: { accent: 'var(--accent-blue)', label: 'Informational', emoji: '🔵', barColor: '#6b9fcf' },
};
      ...
      <div style={{ position: 'relative', zIndex: 1, flex: 1, display: 'flex', flexDirection: 'column' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 10, marginTop: 'auto' }}>
          {isDualButtonForm(form.title) ? (
            ...
            <>
              {/* View button (if viewUrl exists and not dual-button) */}
              {form.viewUrl && (
                <a
...
const FormsSection: React.FC<{
  ...
  isOpen: boolean;
  onToggle: () => void;
}> = ({ id, title, subtitle, emoji, barColor, forms, sectionAccent, isOpen, onToggle }) => {
  return (
    <div
      id={id}
...
const requiredForms: FormItem[] = [
  {
    ...
    description: 'Official SBA requirements for collateral release requests',
    viewUrl: 'https://www.sba.gov/document/support-release-collateral-requirement-letter-0',
    downloadPath: 'https://rufgrcaxemvewhqiayfk.supabase.co/storage/v1/object/public/sbaforms//CESC%20Release%20of%20Collateral%204.2025%20V1.pdf',
    accentColor: '#D4B483',
  },
  {
    title: 'Collateral Release Intended Use Letter',
    description: 'Letter template explaining how collateral release proceeds will be used',
    downloadPath: 'https://rufgrcaxemvewhqiayfk.supabase.co/storage/v1/object/public/sbareconfreehelpguides/ROC/Request%20for%20Covid%20EIDL%20Release%20of%20Collateral%20(FILLABLE)%20-%20FINAL.docx',
    instructionsPath: 'https://rufgrcaxemvewhqiayfk.supabase.co/storage/v1/object/public/sbareconfreehelpguides/ROC/Request%20for%20Release%20of%20Collateral%20Instructions.pdf',
  ...
  {
    title: 'Collateral Release Intended Use Letter - Real Estate',
    description: 'Letter template explaining how collateral release proceeds will be used for real estate',
    downloadPath: 'https://rufgrcaxemvewhqiayfk.supabase.co/storage/v1/object/public/sbareconfreehelpguides/ROC/Real%20Estate%20Collateral%20Release%20Request%20(FILLABLE).docx',
    instructionsPath: 'https://rufgrcaxemvewhqiayfk.supabase.co/storage/v1/object/public/sbareconfreehelpguides/ROC/COVID%20EIDL%20ROC%20RE%20Request%20Letter%20Instructions%20(COMPLETE)%20(1).pdf',
    customDate: '*LAST UPDATED JANUARY 30, 2026*',
    accentColor: '#D4B483',
    primaryButtonText: 'Download Instructions',
    downloadButtonText: 'Unlock Request Template',
  },
  {
    ...
    description: 'Official SBA requirements for substituting collateral',
  ...
  {
    title: 'Title Report Instructions',
    description: 'Guidelines for obtaining and submitting property title reports when required',
    downloadPath: 'https://rufgrcaxemvewhqiayfk.supabase.co/storage/v1/object/public/SMALLBIZRECON-FREEPUBLIC/Real_Estate_Collateral_Release_Request_Title_Report_Instructions_2026.pdf',
    customDate: '*Last updated February 22, 2026*',
    accentColor: '#D4B483',
  },
  {
    title: 'Hazard Insurance Instructions',
    description: 'Guidelines for maintaining proper insurance coverage during collateral release',
    downloadPath: 'https://zrktinvphjmalvrsjmii.supabase.co/storage/v1/object/sign/SmallBiz%20Recon%20Paid%20Templates/Hazard%20Insurance%20for%20COVID.pdf?token=eyJraWQiOiJzdG9yYWdlLXVybC1zaWduaW5nLWtleV8xZmUwNzEzYS00ZTVhLTQ3ZWYtODNlNS0xYjgxOWVlMjk2NzgiLCJhbGciOiJIUzI1NiJ9.eyJ1cmwiOiJTbWFsbEJpeiBSZWNvbiBQYWlkIFRlbXBsYXRlcy9IYXphcmQgSW5zdXJhbmNlIGZvciBDT1ZJRC5wZGYiLCJpYXQiOjE3NzE4MzM5MDcsImV4cCI6MTgzMDI0MDMwN30.KueOW7Eg286TPhnBIdYYbI8gLl7qT8ZfRPPa7bXTNro',
    customDate: '*Last updated February 22, 2026*',
    accentColor: '#D4B483',
  },
  {
    title: 'Collateral Release Submission Checklist',
    description: 'Comprehensive checklist to ensure your collateral release package is complete before submission',
    downloadPath: 'https://zrktinvphjmalvrsjmii.supabase.co/storage/v1/object/sign/SmallBiz%20Recon%20Paid%20Templates/ROC%20SUBMISSION%20CHECKLIST.pdf%20(1).pdf?token=eyJraWQiOiJzdG9yYWdlLXVybC1zaWduaW5nLWtleV8xZmUwNzEzYS00ZTVhLTQ3ZWYtODNlNS0xYjgxOWVlMjk2NzgiLCJhbGciOiJIUzI1NiJ9.eyJ1cmwiOiJTbWFsbEJpeiBSZWNvbiBQYWlkIFRlbXBsYXRlcy9ST0MgU1VCTUlTU0lPTiBDSEVDS0xJU1QucGRmICgxKS5wZGYiLCJpYXQiOjE3NzE4MzMyMTEsImV4cCI6MTgzMDIzOTYxMX0.3h77fbB3cy0NgGvPZ1sbfBhRSZUP9aJQQn5dluba8UE',
    customDate: '*Last updated February 22, 2026*',
    accentColor: '#D4B483',
  },
  {
    title: 'ROC Submission Cover Sheet',
    description: 'Template cover sheet for organizing your collateral release submission',
    downloadPath: 'https://zrktinvphjmalvrsjmii.supabase.co/storage/v1/object/sign/SmallBiz%20Recon%20Paid%20Templates/ROC_COVER_AND_%20CHECKLIST_(2026).pdf?token=eyJraWQiOiJzdG9yYWdlLXVybC1zaWduaW5nLWtleV8xZmUwNzEzYS00ZTVhLTQ3ZWYtODNlNS0xYjgxOWVlMjk2NzgiLCJhbGciOiJIUzI1NiJ9.eyJ1cmwiOiJTbWFsbEJpeiBSZWNvbiBQYWlkIFRlbXBsYXRlcy9ST0NfQ09WRVJfQU5EXyBDSEVDS0xJU1RfKDIwMjYpLnBkZiIsImlhdCI6MTc3MTgzMzY3MywiZXhwIjoxODMwMjQwMDczfQ.Ksz9KQfko5RoQBTnFd6-4PZK7sN8Pf0vq97p-zOYXJc',
    customDate: '*Last updated February 22, 2026*',
    accentColor: '#D4B483',
  },
  {
    title: 'Collateral Valuation Guidelines',
    description: 'Instructions for obtaining and submitting property valuations for collateral release',
    downloadPath: 'https://zrktinvphjmalvrsjmii.supabase.co/storage/v1/object/sign/SmallBiz%20Recon%20Paid%20Templates/Collateral%20Valuation%20Guidelines.pdf?token=eyJraWQiOiJzdG9yYWdlLXVybC1zaWduaW5nLWtleV8xZmUwNzEzYS00ZTVhLTQ3ZWYtODNlNS0xYjgxOWVlMjk2NzgiLCJhbGciOiJIUzI1NiJ9.eyJ1cmwiOiJTbWFsbEJpeiBSZWNvbiBQYWlkIFRlbXBsYXRlcy9Db2xsYXRlcmFsIFZhbHVhdGlvbiBHdWlkZWxpbmVzLnBkZiIsImlhdCI6MTc3MTg1MDc5MywiZXhwIjoxODMwMjU3MTkzfQ.pnOC5DD38XqranLP2eAaYppCHWyAvTbCXbjgJXwLC8s',
    customDate: '*Last updated February 22, 2026*',
    accentColor: '#D4B483',
  },
];
...
const optionalForms: FormItem[] = [
  ...
  {
    title: 'Appraisal Requirements (Instructions)',
    description: 'Guidelines for obtaining and submitting property appraisals when required',
    downloadPath: 'https://rufgrcaxemvewhqiayfk.supabase.co/storage/v1/object/sign/sbarecon-paid-pdfs/RELEASE%20OF%20COLLATERAL/SBA%20COVID%20Appraisal%20Instructions.pdf?token=eyJraWQiOiJzdG9yYWdlLXVybC1zaWduaW5nLWtleV85MzZjNmFmNC1iMzA2LTQzMmMtYWFjNy03ZmRmYjU1NDRjMzUiLCJhbGciOiJIUzI1NiJ9.eyJ1cmwiOiJzYmFyZWNvbi1wYWlkLXBkZnMvUkVMRUFTRSBPRiBDT0xMQVRFUkFML1NCQSBDT1ZJRCBBcHByYWlzYWwgSW5zdHJ1Y3Rpb25zLnBkZiIsImlhdCI6MTc1MjIzOTU1MywiZXhwIjoxODM4NjM5NTUzfQ.89qTWBpebOexEkutdwFlvM401X98M1FM5VOnqKFoAoM',
    accentColor: '#3B4C1C',
  },
  {
    title: 'Sample Loan Commitment Letter',
    description: 'Sample term sheets showing acceptable collateral release structures',
...
const CollateralFormsPage: React.FC = () => {
  ...
  const videoUrl =
    'https://zrktinvphjmalvrsjmii.supabase.co/storage/v1/object/sign/SmallBiz%20Recon%20Paid%20Templates/smallbiz_recon_trailer%20(1).mp4?token=eyJraWQiOiJzdG9yYWdlLXVybC1zaWduaW5nLWtleV8xZmUwNzEzYS00ZTVhLTQ3ZWYtODNlNS0xYjgxOWVlMjk2NzgiLCJhbGciOiJIUzI1NiJ9.eyJ1cmwiOiJTbWFsbEJpeiBSZWNvbiBQYWlkIFRlbXBsYXRlcy9zbWFsbGJpel9yZWNvbl90cmFpbGVyICgxKS5tcDQiLCJpYXQiOjE3NzE4MzEwMjUsImV4cCI6MTgzMDIzNzQyNX0.N8wzYa6x1WcIQoVXngKrSQt0fNZyFxXZhBjKzVitKaQ';
    ...
    <>
      <style>{`
        ...
        * { box-sizing: border-box; }
        ...
        .forms-page a { color: inherit; }

        @media (max-width: 768px) {
          .forms-hero-title { font-size: 28px !important; }
          .forms-hero-inner { padding: 36px 16px 48px !important; }
        }
      `}</style>
      ...
      <div className="forms-page">
        ...
        <div style={{ position: 'relative', zIndex: 1 }}>
          ...
          <div style={{
            ...
            <div className="forms-hero-inner" style={{
              maxWidth: 1200,
              margin: '0 auto',
              ...
              <h1 className="forms-hero-title" style={{
                fontFamily: 'var(--font-display)',
                fontSize: 46,
                fontWeight: 400,
                textAlign: 'center',
              ...
              <p style={{
                ...
                Premium collateral release forms categorized by usage. All forms are included with your toolkit access.
              </p>
              ...
              <div style={{ padding: '28px 28px 8px', textAlign: 'center' }}>
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 10, marginBottom: 12 }}>
                  ...
                  <h2 style={{
                    ...
                    SmallBiz Recon™{' '}
                    <span style={{ fontStyle: 'italic', color: 'var(--accent-gold)' }}>Overview</span>
                  </h2>
                </div>
                <p style={{
                  fontSize: 14,
                  ...
                  Watch a quick overview of how SmallBiz Recon™ helps you navigate SBA processes.
                </p>
              </div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
              <div style={{ animation: 'fadeSlideUp 0.7s ease-out 0.25s both' }}>
                <FormsSection
                  ...
                  subtitle="These forms are mandatory for collateral release submission. Missing any of these will result in delays or rejection."
                  emoji="🔴"
                  barColor="#cf6b6b"
                  forms={requiredForms}
              ...
              <div style={{ animation: 'fadeSlideUp 0.7s ease-out 0.35s both' }}>
                <FormsSection
                  id="informational"
                  title="Informational"
                  subtitle="General references and background information to help you understand the collateral release process."
                  emoji="🔵"
                  barColor="#6b9fcf"
              ...
              <div style={{ display: 'flex', alignItems: 'flex-start', gap: 12 }}>
                ...
                <div>
                  ...
                  <div style={{
                    ...
                    <p>• For collateral release requests, accurate valuation documentation is critical</p>
                  </div>
                </div>
              </div>
            </div>
...
export default CollateralFormsPage;